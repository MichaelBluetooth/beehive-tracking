...
import { EggsIntentService } from './eggs-intent.service';

describe('EggsIntentService', () => {
  let service: EggsIntentService;
  ...
  beforeEach(() => {
    ...
    service = TestBed.inject(EggsIntentService);
  });

  it('Adds a note with the right observation checked', () => {
    expect(service.getNote().eggs).toBeTrue();
  });
});
