...
import { QueenCellsIntentService } from './queen-cells-intent.service';

describe('QueenCellsIntentService', () => {
  let service: QueenCellsIntentService;
  ...
  beforeEach(() => {
    ...
    service = TestBed.inject(QueenCellsIntentService);
  });

  it('Adds a note with the right observation checked', () => {
    expect(service.getNote().queenCells).toBeTrue();
  });
});
