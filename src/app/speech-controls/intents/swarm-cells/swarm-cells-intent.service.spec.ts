...
import { SwarmCellsIntentService } from './swarm-cells-intent.service';

describe('SwarmCellsIntentService', () => {
  let service: SwarmCellsIntentService;
  ...
  beforeEach(() => {
    ...
    service = TestBed.inject(SwarmCellsIntentService);
  });

  it('Adds a note with the right observation checked', () => {
    expect(service.getNote().swarmCells).toBeTrue();
  });
});
