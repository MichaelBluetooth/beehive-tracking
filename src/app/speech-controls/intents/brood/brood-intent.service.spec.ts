...
import { BroodIntentService } from './brood-intent.service';

describe('BroodIntentService', () => {
  let service: BroodIntentService;
  ...
  beforeEach(() => {
    ...
    service = TestBed.inject(BroodIntentService);
  });

  it('Adds a note with the right observation checked', () => {
    expect(service.getNote().brood).toBeTrue();
  });
});
