...
import { LarvaIntentService } from './larve-intent.service';

describe('LarvaIntentService', () => {
  let service: LarvaIntentService;
  ...
  beforeEach(() => {
    ...
    service = TestBed.inject(LarvaIntentService);
  });

  it('Adds a note with the right observation checked', () => {
    expect(service.getNote().larva).toBeTrue();
  });
});
